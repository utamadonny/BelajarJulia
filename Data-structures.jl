...
#This code gives an error when un-commented.
...
# ```
# ------------------------------------------------------------------------------------------
flexible_phonebook=copy(myphonebook)
flexible_phonebook
#-----------------------------------------------------------------------#
 flexible_phonebook = Dict("Jenny" => 8675309, "Ghostbusters" => "555-2368")
...
pop!(flexible_phonebook) #why delete jenny???
flexible_phonebook["Emergency"] = 911
flexible_phonebook
...
# ------------------------------------------------------------------------------------------
#Because the type of flexible_phonebook is Dict{String, Any}. How myphonebook do the same?
# just initialize the same way like flexible_phonebook, initialized with int value

println("Everything worked, but as noted above, if you want to see the output of something, you need to wrap in in println()")
