...
# ╔═╡ 5a2ef084-e0ca-11eb-0cab-697ac582c0d9
using FFTW,DSP,WAV,FileIO,WebIO,OffsetArrays,PlutoUI,Plots

# ╔═╡ caf26654-0d58-4f28-ad2e-8c06a2ffa35b
begin
	files = download.([
...
# ╔═╡ 4d10c1e0-6afd-4356-8378-f835efa1ba2c
sounds = wavread.(files)

# ╔═╡ cf82e186-28f1-4887-9813-1027a95a74b3
signals = [sound[1][:, 1] for sound in sounds]

# ╔═╡ e0d5fecb-6742-454e-a3ce-b903c576432a
md"When you zoom in on one of the first four sounds, it looks like a simple periodic pattern with some frequency."

# ╔═╡ 44a85a4c-1d95-44b0-b033-5fb0c7c419e2
plot(signals[1], xlims=(20000, 22000))

# ╔═╡ 36a10870-3ab6-48a7-b69d-dae3fac67224
md"The final sound is the sum of these first four, and gives a more complicated wave"

# ╔═╡ 6ec03063-a405-4a23-8f52-e794935d7b6f
plot(signals[5], x_lims=(20000, 22000))

# ╔═╡ 42fac539-50fc-4a48-b478-bbb8e8ca4fae
...
# ╔═╡ bc99baa5-d4d9-4766-be02-942863bf55ce
signal_ffts = fft.(signals)

# ╔═╡ 81b0d641-aa20-4670-a048-b8ba555bf287
plot(
	[abs.(signal_ffts[i]) for i in 1:4],
	x_lims=(1, 1000)
)

# ╔═╡ f1ecaa4c-349d-4224-8431-e012f578b294
plot(
	abs.(signal_ffts[5]),
	x_lims=(1, 1000)
)

# ╔═╡ 88952523-569d-45cc-b827-156ada3a2cc7
md"### Writing our own DFT function"

# ╔═╡ e685efda-cb3d-48c1-bcfe-1291fc4e19db
...
# ╔═╡ d6744f5f-63b8-4f35-a4e5-41edd4273198
function dft(signal)
	N = length(signal)
...
# ╔═╡ 75f69eec-b615-42b1-a1da-e012f2cede36
...
# ╔═╡ 717a83bb-4dbe-4f1f-9bad-2f05b5feb9b5
N = 10000

# ╔═╡ 23ba7950-49ec-4491-8d3f-4c0001c2ae9d
signal=signals[1][1:N]

# ╔═╡ 689231b3-c0c5-446a-8be9-ea9f8217981c
signal_fft = fft(signal)

# ╔═╡ 36f55658-fd98-40a9-bbd8-71e758524bed
signal_dft = dft(signal)

# ╔═╡ cdfe4412-3fe2-4820-a625-940f2cb96345
...
git-tree-sha1 = "924935e4a24604784a79244cac529caa0e6b7aff"
